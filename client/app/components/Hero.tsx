    ...
    <section className="flex min-h-[calc(100vh-64px)] flex-col items-center justify-center bg-black px-6 text-center text-white">
      ...
      <div className="mt-10 flex flex-wrap justify-center gap-4">
        <button
          ...
          className="rounded-xl bg-cyan-500 px-7 py-3 font-semibold text-black transition hover:bg-cyan-400"
        >
          Upload Video
        </button>
        ...
        <button
          ...
          className="rounded-xl border border-cyan-500 px-7 py-3 font-semibold text-cyan-400 transition hover:bg-cyan-500 hover:text-black"
        >
          Watch Demo
        </button>
      </div>
